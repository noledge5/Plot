...
func (s *Server) routes() {
	...
	geschuetzt.HandleFunc("PUT /api/facts/{id}", s.handleUpdateFact)
	geschuetzt.HandleFunc("POST /api/facts/{id}/retire", s.handleRetireFact)
	geschuetzt.HandleFunc("DELETE /api/facts/{id}", s.handleDeleteFact)
	geschuetzt.HandleFunc("GET /api/stories/{id}/chronik", s.handleChronik)
	geschuetzt.HandleFunc("DELETE /api/summaries/{id}", s.handleDeleteSummary)
	...
	geschuetzt.HandleFunc("POST /api/stories/{id}/korrektur", s.handleKorrektur)
	geschuetzt.HandleFunc("POST /api/stories/{id}/zeitsprung", s.handleZeitsprung)
	geschuetzt.HandleFunc("GET /api/stories/{id}/regie-regeln", s.handleRegieRegeln)
	geschuetzt.HandleFunc("POST /api/stories/{id}/regie-regeln", s.handleRegieRegelAnlegen)
	geschuetzt.HandleFunc("DELETE /api/stories/{id}/regie-regeln/{nr}", s.handleRegieRegelLoeschen)
